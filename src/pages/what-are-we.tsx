  ...
  <Layout location={location}>
    <>
      <Seo
        ...
        location={location}
        og={{ type: "website" }}
        meta={{ title: "What are we?", description: "", keywords: "" }}
      />
      <h1>What are we?</h1>
      <p>
        Mental illness has been a stigma for like forever now, even in times
        like these. It’s the year 2020, the age of the millennials. Most of the
        half are struggling with things “we are not supposed to talk about”.
      </p>
      <p>
      ...
      <blockquote>
        ...
        not comforted Cared for but not looked after We are someone they listen
        to but not hear. The Unheards.
      ...
      <p>
        ...
        because we were all made special and different. No success is
